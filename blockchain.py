...
class Blockchain:
    ...
    def delete_blocks(self, seq):
        index = self.chain[seq]['index']
        prev_hash = self.chain[seq]['previous_hash']
        merkle_root = self.chain[seq]['merkle_tree']

        this_hash = self.chain[seq + 1]['previous_hash']
        self.chain[seq + 1]['previous_hash'] = prev_hash
        ...
        self.removed_blocks.append(removed_block)
